...
const returnGreeting = () =>{
    ...
    if (curHr <= 8) {
        greeting.innerText = "Good morning, Benedict"
    } else if (curHr <= 12) {
        greeting.innerText = "Good day, Benedict"
    } else if (curHr <= 18) {
        greeting.innerText = "Good afternoon, Benedict"
    } else {
        greeting.innerText = "Good evening, Benedict"
    }
}
...
let weather = {
    ...
    const pictures = [
            [
                ...
                "img/shirts/shirt_2..jfif",
                "img/shirts/shirt_3.jpeg",
              
            ],
            [
              "img/pants/pants_1.jpg",
              "img/pants/pants_2.jpg"
            ],
            [
              "img/sweaters/sweater_1.jfif",
              "img/sweaters/sweater_2.jpg",
